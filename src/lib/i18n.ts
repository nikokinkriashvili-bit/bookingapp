...
const en = {
  ...
  "job.conditionWheels": "Wheels",
  "job.conditionInterior": "Interior",
  "job.conditionDamageNoted": "Pre-existing damage",
  "job.conditionNotePlaceholder": "Describe any existing damage...",
  "job.conditionPhotos": "Condition photos",
  "job.addConditionPhoto": "+ Add photo",
  ...
  "vehicle.addBeforePhoto": "+ Before photo",
  "vehicle.addAfterPhoto": "+ After photo",
  "vehicle.photoSourceCamera": "Take photo",
  "vehicle.photoSourceLibrary": "Choose from library",
  "vehicle.noPhotos": "No photos yet.",
  "vehicle.deletePhotoConfirm": "Delete this photo?",
  ...
  // Quote flow (booking pivot, Slice 2)
  "quote.title": "Quote",
  "quote.hint": "After inspecting, quote a price and describe the work. Sending WhatsApp goes live at integration; for now flip the response by hand.",
  "quote.descriptionPlaceholder": "What you'll do (e.g. exterior polish + interior deep clean)",
  "quote.pricePlaceholder": "Quoted price ₾",
  "quote.saveDraft": "Save draft",
  "quote.send": "Send quote",
  "quote.sendAgain": "Send again",
  "quote.markAccepted": "Mark accepted",
  "quote.markDeclined": "Mark declined",
  "quote.validUntil": "Valid until",
  "quote.status.draft": "Draft",
  "quote.status.sent": "Sent — awaiting reply",
...
const ka: Record<StringKey, string> = {
  ...
  "job.conditionWheels": "ბორბლები",
  "job.conditionInterior": "სალონი",
  "job.conditionDamageNoted": "წინასწარი დაზიანება",
  "job.conditionNotePlaceholder": "აღწერეთ არსებული დაზიანება...",
  "job.conditionPhotos": "მდგომარეობის ფოტოები",
  "job.addConditionPhoto": "+ ფოტოს დამატება",
  ...
  "vehicle.addBeforePhoto": "+ ფოტო (მანამდე)",
  "vehicle.addAfterPhoto": "+ ფოტო (შემდეგ)",
  "vehicle.photoSourceCamera": "გადაღება",
  "vehicle.photoSourceLibrary": "გალერეიდან არჩევა",
  "vehicle.noPhotos": "ფოტოები ჯერ არ არის.",
  "vehicle.deletePhotoConfirm": "წავშალო ეს ფოტო?",
  ...
  "quote.title": "შეთავაზება",
  "quote.hint": "დათვალიერების შემდეგ დაასახელე ფასი და აღწერე სამუშაო. WhatsApp-ით გაგზავნა ინტეგრაციაზე ჩაირთვება; ახლა პასუხი ხელით მონიშნე.",
  "quote.descriptionPlaceholder": "რას გააკეთებ (მაგ. გარე პოლირება + სალონის ღრმა წმენდა)",
  "quote.pricePlaceholder": "შემოთავაზებული ფასი ₾",
  "quote.saveDraft": "მონახაზის შენახვა",
  "quote.send": "შეთავაზების გაგზავნა",
  "quote.sendAgain": "თავიდან გაგზავნა",
  "quote.markAccepted": "მიღებულად მონიშვნა",
  "quote.markDeclined": "უარყოფად მონიშვნა",
  "quote.validUntil": "მოქმედია",
  "quote.status.draft": "მონახაზი",
  "quote.status.sent": "გაგზავნილი — პასუხის მოლოდინში",
